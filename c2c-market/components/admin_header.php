<header>
    <div class="logo">
        <img src="../image/logo.webp" width="200"> 
    </div>
    <div class="right">
    ...
    <div class="profile-detail">
        <?php
            ...
            <div class="profile"> 
                ...
                <div class="flex-btn"> 
                    <a href="profile.php" class="btn">profiles</a> 
                    <a href="../components/admin_logout.php" onclick="return confirm('logout this website?');" class="btn">logout</a>
                </div>
            </div> 
        <?php } ?> 
    </div> 
